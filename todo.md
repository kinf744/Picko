...
- [x] Valider TypeScript, les tests et la compilation GitHub Actions armeabi-v7a — run 32220392080 réussi, commit 2bd97023, APK 45,63 Mio
...
## Balancier multi-profils et Clipboard

- [x] Auditer pourquoi le round robin ne s’active pas ou ne change pas de profil
- [x] Activer le balancier uniquement quand au moins deux profils de la même famille sont sélectionnés
- [x] Faire alterner les profils à chaque nouvelle connexion, tout en gardant un profil unique en connexion directe
