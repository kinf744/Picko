...
export default function ConfigImportScreen() {
  ...
  const loadContent = (content: string, source: string) => {
    if (!content.trim()) throw new Error("Le presse-papiers ne contient aucune configuration.");
    if (content.length > 1_000_000) throw new Error("La configuration dépasse la limite autorisée de 1 Mo.");
