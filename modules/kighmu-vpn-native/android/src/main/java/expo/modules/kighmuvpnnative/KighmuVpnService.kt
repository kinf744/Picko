  ...
  private fun restartVpn(generation: Long, reason: String) {
    ...
    thread(isDaemon = true, name = "picko-vpn-restart") {
      ...
      try {
        ...
        // Réseau physique absent (données mobiles coupées, avion, etc.) :
        // on NE ferme PAS le VPN, on re-boucle avec backoff jusqu'au retour
        // du réseau ou jusqu'à un arrêt manuel de l'utilisateur.
